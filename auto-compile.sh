...
SRC_DIR="/epics/base/base-7.0.9/synApps_6_3/support/areaDetector-R3-12-1/ADGermanium/germaniumApp/src"
DB_DIR="/epics/base/base-7.0.9/synApps_6_3/support/areaDetector-R3-12-1/ADGermanium/germaniumApp/Db"

# Map: directory => "ext1|ext2|ext3"
declare -A WATCH_EXTS=(
  ["$SRC_DIR"]="c|cpp|hpp|dbd"
  ["$DB_DIR"]="db|template"
)
