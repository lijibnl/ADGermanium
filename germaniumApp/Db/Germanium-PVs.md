...
PV | TYPE | MARS-CFG | ADDR | VALUE | NOTE
:-:|:-:|:-:|:-:|:-|:-
MODE | bo   | No | 0 | 0: Framing<br>1: Continuous | Set framing mode.
CONT | bo   | No |0 | 0: OneShot<br>1: AutoCount | Set count mode.
EBLK  | mbbo | Yes | 0 | 1: 2pA | Enable on-chip bias current generator.
GAIN | mbbo | Yes | 0 | 0: 240keV<br>1: 120keV<br>2: 60keV<br>3: 30keV | Set gain.
LEAK | mbbo | ? | 0 | 0: Off<br>1: 2pA<br>2: 8pA | PV doesn't exist?
LOAO  | bo   | Yes | 0 | 0: Leakage<br>1: Pulse | Set channel monitor to leakage or pulse.
MFS   | mbbo | Yes | 0 | 0: Off<br>1: 250ns<br>2: 500ns<br>3: 1us<br>4: 2us | Multi-fire suppression.
OFFS | | No | 0 | |  Energy calibration offset. Used in spctx calculation.
PLDEL | longout | No | 0 | | Set pipeline delay.
PUEN  | bo | Yes | 0 | 0: Disable<br>1: Enable | Pileup Rejection enable.
??? PUTF | waveform | Yes | 0 | $(NELM) | Array of pileup rejection values.
PUTR | waveform | Yes |0 | $(NELM) | Array of NCHAN pileup threshold trim values.
RODEL | longout | No | 0 | | Set readout delay.
SHPT | mbbo | Yes | 0 | 1: 0.25us<br>2: 0.5us<br>3: 1us<br>4: 2us | Set shaping time.
SLP | ao | No | 0 | Used in spctx calculation.
TDS  | mbbo | Yes | 0 | 0: 1us<br>1: 2us<br>2: 3us<br>3: 4us<br>4: 6us<br>5: 9us<br>6: 12us | Set time detector slope.
TDM  | bo   | Yes | 0 | 0: Time of arrival<br>1: Time over threshold | Set TDC mode.
THRSH | waveform | Yes | 0 | $(NCHIPS) | Threshold
THTR | waveform | Yes | 0 | $(NELM) | Array of NCHAN trim DAC values.

- ## Test pulse

PV | TYPE | MARS-CFG | ADDR | SIZE | VALUE | NOTE
:-:|:-:|:-:|:-:|:-|:-|:-
CHEN  | waveformout | Yes | 0 | $(NELM) |  | Channel enable (per channel).
POL   | bo | Yes | 0 | | 0: Negative<br>1: Positive | Set input polarity.
TPAMP | longout | Yes | 0 | |  | Set test pulse amplitude.
TPCNT | longout | Yes | 0 | |  | Set test pulse count.
TSEN  | waveformout | Yes | 0 | $(NELM) |  | Test pulse enable (per channel).
TPENB | bo | Yes | 0 | | 0: Off<br>1: On | Enable test pulses. Writes to MARS_CALPULSE. Why MARS-CFG?
TPFRQ | longout | Yes | 0 | |  | Set test pulse frequency. Wirtes to CALPULSE_WIDTH. Why MARS-CFG?
...
PV | TYPE | MARS-CFG | ADDR | VALUE | NOTE
:-:|:-:|:-:|:-:|:-|:-
CNT   | bo | No | 0 | 0: Stop<br>1: Start    | Acquisition control.
GMON | mbbo | Yes | 0 | 0: Off<br>1: Temperature<br>2: Baseline<br>3: Threshold<br>4: Test pulse<br>5: Channel monitor | Set switch for channel monitors or others.
PR1 | | No | 0 | | Integer preset for count.
RUNNO | longout | No | 0 |  |
MONCH | longout | Yes | 0 |  | Set channel which has monitor out enabled.
TP  | ao | No | 0 |  |
TP1 | ao | No | 0 |  |
