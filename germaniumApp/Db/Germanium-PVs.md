...
EBLK  | mbbo | 0 | 1: 2pA | Enable on-chip bias current generator.
...
OFFS | | 0 | |  Energy calibration offset.
PLDEL | longout | 0 | | Set pipeline delay.
PUEN  | bo | 0 | 0: Disable<br>1: Enable | Pileup Rejection enable.
PUTF | waveform | 0 | $(NELM) | Array of pileup rejection values.
PUTR | waveform | 0 | $(NELM) | Array of NCHAN pileup threshold trim values.
...
THRSH | waveform | 0 | $(NCHIPS) | Threshold
THTR | waveform | 0 | $(NELM) | Array of NCHAN trim DAC values.
