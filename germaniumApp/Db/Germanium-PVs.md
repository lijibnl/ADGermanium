...
CHEN_SET | mbbo | MARS | 0 | | 0: Enable channel `$(MONCH)`<br>1: Enable all channels<br>2: Disable channel `$(MONCH)`<br>3: Disable all channels | Set channel enable
...
TSEN_SET | mbbo | MARS | 0 | | 0: Enable channel `$(MONCH)`<br>1: Enable all channels<br>2: Disable channel `$(MONCH)`<br>3: Disable all channels | Set test pulse enable
